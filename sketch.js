...
createCanvas(windowWidth,windowHeight)
  ...
  gameOver.scale = windowHeight/900;
  restart.scale = windowHeight/900;
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(windowWidth/2,height-30,width,125);
    //obstacle.debug = true;
    ...
    obstacle.scale = windowHeight/850;
